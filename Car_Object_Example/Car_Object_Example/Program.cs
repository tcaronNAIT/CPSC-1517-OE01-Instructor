...
static void TestVehicleClass()
{
    ...
    try
    {
        //Good Vehicle - Normal
        newEngine = new Engine(1.0, 24, 0);
        newTransmission = new Transmission(Transmission.TypeName.Standard, 6);
        newVehicle = new Vehicle("Honda", "Civic", newEngine, newTransmission, 4);
        //Good Vehicle - 3 wheels
        newVehicle = new Vehicle("Honda", "Civic", newEngine, newTransmission, 3);
        //Good Vehicle - Unicorn with 4 wheels
        newTransmission = new Transmission(Transmission.TypeName.Unicorn, 6);
        newVehicle = new Vehicle("Honda", "Civic", newEngine, newTransmission, 4);


        //Bad Wheels - Negative Number
        //newVehicle = new Vehicle("Honda", "Civic", newEngine, newTransmission, -4);

        //Bad Wheels - Over 12
        //newVehicle = new Vehicle("Honda", "Civic", newEngine, newTransmission, 15);

        //Bad Wheels - Unicorn and not 4
        //newTransmission = new Transmission(Transmission.TypeName.Unicorn, 6);
        //newVehicle = new Vehicle("Honda", "Civic", newEngine, newTransmission, 6);

        //Bad Wheels - Odd Number
        //newTransmission = new Transmission(Transmission.TypeName.Standard, 6);
        //newVehicle = new Vehicle("Honda", "Civic", newEngine, newTransmission, 7);

        //Blank Make
        //newVehicle = new Vehicle("", "Civic", newEngine, newTransmission, 4);

        //Blank Model
        //newVehicle = new Vehicle("Honda", "", newEngine, newTransmission, 4);
    }
    catch(Exception ex)
    {
        Console.WriteLine(ex.Message);
